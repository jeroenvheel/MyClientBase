...
class Lib_output {
    ...
    function html($invoice_id, $invoice_template) {
        ...
        // TODO : Remove line when it's adopted
		$this->CI->parser->parse('invoices/invoice_templates/' . $invoice_template, $data);
    ...
    function pdf($invoice_id, $invoice_template) {
        ...
        $data = array(
         ...
         // TODO : Remove line when it's adopted
		$html = $this->CI->parser->parse('invoices/invoice_templates/' . $invoice_template, $data, TRUE);
	...
	function payment_link($invoice) {
		...
		$this->CI->merchant->driver = strtolower($this->CI->mdl_mcb_data->setting('merchant_driver'));
